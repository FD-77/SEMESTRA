                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-4">
                        <div className="border rounded-lg p-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-3">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 cursor-text [&::-webkit-calendar-picker-indicator]:cursor-pointer"
                                    />
                                </div>
                                <div>
                                    <label className="block text-sm text-gray-700">
                            ...
                            <button
                                ...
                                className="w-full px-4 py-2 bg-purple-600 text-white rounded-md cursor-pointer hover:bg-purple-700"
                            >
                                Add Time Slot
                            </button>
                        </div>
                    ...
                    <div className="flex justify-end space-x-3 mt-6">
                        <button
                            type="button"
                            onClick={onClose}
                            className="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium cursor-pointer text-gray-700 bg-white hover:bg-gray-50"
                        >
                            Cancel
                        </button>
                        <button
                            type="submit"
                            className="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium cursor-pointer text-white bg-purple-600 hover:bg-purple-700"
                        >
